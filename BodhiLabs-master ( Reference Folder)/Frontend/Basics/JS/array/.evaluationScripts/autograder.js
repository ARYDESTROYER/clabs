    ...
    const testCases = [
        ...
        },
        {
            ...
            check: async () => {
                const outputText = await page.evaluate(() => {
                    const outputElement = document.getElementById('output');
                    return outputElement.innerHTML.includes('Array After Adding Element 1 to End: 1,2,3,4,5,1');
                });
                return outputText;
            }
        },
        ...
        },
        {
            ...
            check: async () => {
                const outputText = await page.evaluate(() => {
                    const outputElement = document.getElementById('output');
                    return outputElement.innerHTML.includes('Array After Adding Element 0 to Beginning: 0,1,2,3,4,5');
                });
                return outputText;
            }
        },
        ...
        },
        {
            ...
            check: async () => {
                const outputText = await page.evaluate(() => {
                    const outputElement = document.getElementById('output');
                    return outputElement.innerHTML.includes('Index of Element with value 3: 2');
                });
                return outputText;
            }
        },
        {
            ...
            check: async () => {
                const outputText = await page.evaluate(() => {
                    const outputElement = document.getElementById('output');
                    return outputElement.innerHTML.includes('Array After Removing Element with Value 3: 1,2,4,5');
                });
                return outputText;
            }
        },
